...
def get_args_parser():
    ...
    parser.add_argument('--set_cost_verb_class', default=1, type=float,
                        help="Verb class coefficient in the matching cost") #hoi
    
    # * Loss coefficients
    parser.add_argument('--dice_loss_coef', default=1, type=float)
    parser.add_argument('--bbox_loss_coef', default=5, type=float)
    parser.add_argument('--giou_loss_coef', default=2, type=float)
    parser.add_argument('--obj_loss_coef', default=1, type=float) #hoi 
    parser.add_argument('--verb_loss_coef', default=1, type=float) #hoi
    parser.add_argument('--eos_coef', default=0.1, type=float,
                        help="Relative classification weight of the no-object class")

    # * Dataset
    parser.add_argument('--dataset_file', default='vcoco')
    parser.add_argument('--coco_path', type=str) # default='/home/Research/MyData/COCO2017'
    parser.add_argument('--coco_panoptic_path', type=str)
    parser.add_argument('--remove_difficult', action='store_true')
    parser.add_argument('--hoi_path',default='./data/v-coco',type=str) #hoi
    ...
    parser.add_argument('--num_queries', default=150, type=int, help="Number of query slots") #hoi

    ####### ViDT Params
    parser.add_argument('--method', default='vidt', type=str, help='method names in {vidt, vidt_wo_neck}')
    parser.add_argument("--det_token_num", default=150, type=int, help="Number of det token in the body backbone")
