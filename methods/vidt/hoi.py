...
class SetCriterionHOI(nn.Module):
    ...
    def __init__(self, num_obj_classes, num_queries, num_verb_classes, matcher, weight_dict, eos_coef, losses, verb_loss_type):
        ...
        self.num_queries = num_queries #hoi
        self.num_verb_classes = num_verb_classes #hoi
        ...
        self.verb_loss_type = verb_loss_type #hoi

    def loss_obj_labels(self, outputs, targets, indices, num_boxes, log=True):
        ...
        #loss_obj_ce = F.binary_cross_entropy_with_logits(src_logits, target_classes_onehot, reduction="none")
        #loss_obj_ce = loss_obj_ce.mean(1).sum() / num_boxes
    ...
    def forward(self, outputs, targets):
        outputs_without_aux = {k: v for k, v in outputs.items() if k != 'aux_outputs' and k != 'enc_outputs'} #hoi
        ...
        if 'enc_outputs' in outputs: #hoi num_boxes -> num_interactions
